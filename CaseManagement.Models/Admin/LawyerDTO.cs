...
{
    public class LawyerDTOResponse
    {
        public DataUpdateResponseDTO DataUpdateResponse { get; set; }
        public List<LawyerDTOList> LawyerDTOList { get; set; }
        ...
        public override string ToString()
        {
            ...
            status += $"LawyerDTOList Count:{this.LawyerDTOList.Count}";
            return status;
        }
    }

    public class LawyerDTOList
    {
