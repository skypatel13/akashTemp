...
{
    public class RescueDTOResponse
    {
        public DataUpdateResponseDTO DataUpdateResponse { get; set; }
        public List<RescueDTOList> RescueDTOList { get; set; }
        ...
        public override string ToString()
        {
            ...
            status += $"RescueDTOResponse Count:{this.RescueDTOList.Count}";
            return status;
        }
    }

    public class RescueDTOList
    {
